package task.task5.p3.controller;

import task.task5.p3.model.TranslatorService;
import task.task5.p3.view.TranslatorInput;
import task.task5.p3.view.TranslatorView;
