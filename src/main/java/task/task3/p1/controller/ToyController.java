package task.task3.p1.controller;

import task.task3.p1.model.domain.PlasticToyType;
import task.task3.p1.model.domain.TabletopGameType;
import task.task3.p1.model.domain.ToyItem;
import task.task3.p1.model.domain.plastictoys.Doll;
import task.task3.p1.model.domain.plastictoys.PlasticToy;
import task.task3.p1.model.domain.plastictoys.Puzzle;
import task.task3.p1.model.domain.plastictoys.ToyBoat;
import task.task3.p1.model.domain.plastictoys.ToyCar;
import task.task3.p1.model.domain.tabletopgames.BoardGame;
import task.task3.p1.model.domain.tabletopgames.CardGame;
import task.task3.p1.model.domain.tabletopgames.TabletopGame;
import task.task3.p1.model.service.Playroom;
import task.task3.p1.model.service.ToysGenerator;
import task.task3.p1.view.ToyInputData;
